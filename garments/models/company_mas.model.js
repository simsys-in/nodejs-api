...
//             DBCON.query(`select count(id) as c from ${TABLE_NAME} where id != ? and company = ?`, [body.id, body.company], (err, count) => {
//                 if (err) {
//                     callback(err)
//                 } else {
//                     if (count[0].c > 0) {
//                         callback("Company Already Found!")
//                     } else {
...
//                                 callback(err)
//                             } else {
//                                 callback(false, result, "Company Updated Successfully")
//                             }
//                         })
//                     }
//                 }
...
//             // body.created_at = new Date();
//             DBCON.query(`select count(id) as c from ${TABLE_NAME} where company = ?`, [body.company], (err, count) => {
//                 if (err) {
//                     callback(err)
//                 } else {
//                     // console.log("DB Query Success")
//                     if (count[0].c > 0) {
//                         callback("Company Name Already Found!")
//                     } else {
//                         DBCON.query(`insert into ${TABLE_NAME} set ?`, body, (err, result) => {
//                             if (err) {
//                                 callback(err)
//                             } else {
//                                 callback(false, result, "Company Saved Successfully!")
//                             }
//                         })
//                     }
//                 }
            ...
            if (err){ 
                ...
                DBCON.query(sql1,match, function (err, result1) {
                    if(err){
                        ...
                        company.company_details = result1;
