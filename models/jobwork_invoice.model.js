...
JobworkInvoiceModel.prototype = {
    ...
    getAll: function (callback) {
        pool.query(`select jobwork_invoice.id,jobwork_invoice.inventory_qty_total, DATE_FORMAT(jobwork_invoice.vou_date, '%d-%m-%Y') as vou_date, ledger.ledger from ${TABLE_NAME} left join ledger on ledger.id=jobwork_invoice.ledger_id  order by jobwork_invoice.id desc`, function (err, result) {
