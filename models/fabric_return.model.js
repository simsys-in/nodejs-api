...
FabricReturnModel.prototype = {
    ...
    getAll : function(callback){
        pool.query(`select fabric_return.id,fabric_return.vouno, DATE_FORMAT(fabric_return.vou_date, '%d-%m-%Y') as vou_date,ledger.ledger from ${TABLE_NAME} left join ledger on ledger.id=fabric_return.ledger_id order by ${TABLE_NAME}.id desc`, function(err, result){
