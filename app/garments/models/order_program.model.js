...
OrderProgramModel.prototype = {
    ...
    //     const QUERY = `select order_program.id,order_program.vou_date,order_program.due_date, order_program.order_no,product.product, size.size from order_program left join product on product.id = order_program.style_id left join size on size.id = order_program.size_id where order_program.id = ${id};`;
    ...
    //             const ORDER_ID = orderstatus_details.order_id;
    ...
    //                             callback(err);
    //                         } else {
    //                             orderstatus_details.color_details = color_details;
    ...
    //                                         } else {
    //                                             orderstatus_details.company_details = company_details[0];
    //                                             DBCON.query(GET_LEDGER_DETAILS, (err, ledger_details) => {
    //                                                 if (err) {
    //                                                     // console.log(err);
    //                                                     callback(err);
    //                                                 } else {
    //                                                     orderstatus_details.ledger_details = ledger_details[0];
    //                                                     callback(false, orderstatus_details);
    //                                                 }
    //                                             });
    //                                         }
    //                                     });
