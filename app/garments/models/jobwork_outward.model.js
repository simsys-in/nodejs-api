...
JobworkOutwardModel.prototype = {
    ...
    getNextJobworkOutwardVouNo: (callback) => {
        var query = 'select ifnull(max(cast(vouno as UNSIGNED)), 0) + 1 as max_vou_no from jobwork_outward';
